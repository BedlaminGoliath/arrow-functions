...
const practiceWay = function(course){
  return `I am currently enrolled in ${course}`;
}

// TODO: Uncomment the following line of code to see the output in the browser console
console.log('The old way:', theOldWay('Code 301'));
console.log('this is the way:', practiceWay('Code 401'));
...
const theOtherWay = (course) => {
  return `I am the current student in ${course}`;
}

// TODO: Uncomment the following line of code to see the output in the browser console
console.log('The new way:', theNewWay('Code 301'));
console.log('random text:', theOtherWay('Code 401'));
...
//This is refering to the Object at hand (Joe)

// 2. What is "this" when joe.scopeArrow() is invoked?

// "this" is refering to the global object (document)
//
// 3. Explain why "this" is different when an arrow function is used.
//this isnt applicable to arrow functions because there is no scope there this specific funtion so we are refering to the document object.
